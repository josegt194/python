...
BOT_TOKEN = "2024662350:AAHhcHlBmeUjVyO4I9LpsLgA-0OLgLXNb1I"
PAYMENT_CHANNEL = "@TeamBlackShark" #add payment channel here including the '@' sign
OWNER_ID = 1003157292 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@TeamBlackShark"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
              #you can add as many channels here and also add the '@' sign before channel username
Daily_bonus = 0.100 #Put daily bonus amount here!
